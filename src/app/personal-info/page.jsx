...
const Page = () => {
  ...
  let allChecked = [firstNameVerified, lastNmaeVerified, firstNameKanaVerified, lastNameKanaVerified, firstPhoneVerified, secondPhoneVerified, thirdPhoneVerified, emailVerified]
    ...
    <main className="pt-8 h-screen bg-cover">
      ...
      <div className="justify-center px-16">
        <div className="grid grid-cols-5 gap-10 w-2/3 items-center m-auto left-4 relative py-8">
          ...
          <PersonInput inputType="text" placeholder="山田" divided={2} variable={firstName} setVariable={setFirstName} isVerified={firstNameVerified} setIsVerified={setFirstNameVerified}/>
          <PersonInput inputType="text" placeholder="太郎" divided={2} variable={lastName} setVariable={setLastName} isVerified={lastNmaeVerified} setIsVerified={setLastNameVerified}/>
        </div>
        <div className="grid grid-cols-5 gap-10 w-2/3 items-center m-auto left-4 relative py-8">
          <span className="pl-6 text-4xl items-start">
          ...
          <div className="col-span-2">
            ...
            <PersonInput inputType="text" placeholder="ヤマタ" divided={2} variable={firstNameKana} setVariable={setFirstNameKana} isVerified={firstNameKanaVerified} setIsVerified={setFirstNameKanaVerified}/>
          </div>
          <div className="col-span-2">
            <p className="pl-8 text-3xl">カタガナで入力してください</p>
            <PersonInput inputType="text" placeholder="タロウ" divided={2} variable={lastNameKana} setVariable={setLastNameKana} isVerified={lastNameKanaVerified} setIsVerified={setLastNameKanaVerified}/>
          </div>
        </div>
        <div className="grid grid-cols-5 gap-10 w-2/3 items-center m-auto left-4 relative py-8 pr-3">
          ...
          <PersonInput inputType="number" divided={3} placeholder="000" variable={firstPhone} setVariable={setFirstPhone} isVerified={firstPhoneVerified} setIsVerified={setFirstPhoneVerified}/>
          <PersonInput inputType="number" divided={3} placeholder="1234" variable={secondPhone} setVariable={setSecondPhone} isVerified={secondPhoneVerified} setIsVerified={setSecondPhoneVerified}/>
          <PersonInput inputType="number" divided={3} placeholder="5678" variable={thirdPhone} setVariable={setThirdPhone} isVerified={thirdPhoneVerified} setIsVerified={setThirdPhoneVerified}/>
          </div>
        </div>
        <div className="grid grid-cols-5 gap-10 w-2/3 items-center m-auto left-4 relative py-8 pr-3">
          <span className="pl-6 text-4xl items-start">
          ...
          <PersonInput inputType="email" divided={1} variable={email} setVariable={setEmail} isVerified={emailVerified} setIsVerified={setEmailVerified}/>
        </div>
      </div>
