    ...
    <main className="bg-[url('../../public/donationBg.jpg')] pt-20 min-h-screen bg-cover">
      <div className="mt-0 tablet:mt-10">
        ...
        <p className="text-4xl tablet:text-6xl font-bold text-center mt-14 mb-16">
          <span className="text-red text-5xl tablet:text-7xl p-2">1</span>パーセント
      ...
      <div className="text-center gap-16 block tablet:flex justify-center w-full bottom-20 pb-10">
        <div className="mb-10 tablet:mb-0">
          <p className="text-base phone:text-xl mb-3 border-b-2 border-nabBg w-fit text-center m-auto text-grayLetter">
