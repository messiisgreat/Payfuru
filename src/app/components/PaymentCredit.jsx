    ...
    <>
      ...
      <div className="w-1/3 m-auto">
        <form action="">
          ...
          <select  className="text-xl font-semibold border border-black p-3 rounded-lg w-1/2 mt-6 outline-none border-opacity-70 block" id="paymentway" name="paymentway">
          ...
          <button className="w-full text-center text-xl font-bold text-white bg-hoverButton p-4 rounded-lg mt-10">お支払い</button>
        </form>
        <button onClick={() => {setPayment(false)}} className=""><p className="border-b w-fit flex gap-2 items-center p-1 mt-4"><Icon icon="fe:arrow-left" width="1.2rem" height="1.2rem" />戻る</p></button>
        <div className="text-center w-1/3 left-1/3 absolute bottom-5">
