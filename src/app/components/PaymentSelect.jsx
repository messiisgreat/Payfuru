...
const PaymentSelect = ({setPayment}) => {
    return (
            ...
            <div className="w-1/3 m-auto">
                ...
                <Link href=""  className="border border-black border-opacity-20 rounded-xl justify-between flex pl-2 pr-1 py-2 items-center my-5 w-1/2 font-semibold"><span>Paypay</span><Icon icon="fe:arrow-right" width="1.2rem" height="1.2rem" /></Link>
